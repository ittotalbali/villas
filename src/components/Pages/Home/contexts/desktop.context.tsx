...
import { getMarkerIcon2 } from "../components/Map/MarkerIcon";
    ...
    debounce((id: number | null, hover: boolean) => {
      ...
      if (!hover || !id) {
        Object.entries(markerRefs.current).forEach(([villaId, marker]) => {
          ...
          if (villa) {
            ...
            //       )}`
            //     : "-";
            marker.setIcon(getMarkerIcon2(villa.total_bedroom!, false));
      ...
      if (marker) {
        ...
        if (villa) {
          ...
          //       )}`
          //     : "-";
          marker.setIcon(getMarkerIcon2(villa.total_bedroom!, true));
